...
export function asyncSend<T extends procSendLike>(proc: T, msg: any): Promise<void> {
...
export function childSend(proc: NodeJS.Process, msg: ChildMessage): Promise<void> {
  return asyncSend<NodeJS.Process>(proc, msg)
}

export function isRedisVersionLowerThan(currentVersion: string, minimumVersion: string): boolean {
...
function getCircularReplacer(rootReference: any) {
...
export function errorToJSON(value: any): Record<string, any> {
